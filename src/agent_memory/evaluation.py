"""Deterministic fixture-backed evaluation harness for Agent Memory."""
...
from agent_memory.lifecycle import review_queue
...
from agent_memory.vault import doctor_report
...
def run_evaluation(fixture_or_file: PathLike, *, keep_working_vault: bool = False) -> EvaluationReport:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="agent-memory-eval-"))
