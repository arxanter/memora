"""Deterministic citation-preserving memory brief generation."""
...
from agent_memory.recall import PackedChunk, RecallResponse, recall_memory
from agent_memory.retrieval import SearchFilters
from agent_memory.schema import LifecycleStatus, MemoryType, RelationType
...
class BriefItem:
    """One deterministic bullet in a memory brief section."""
